...
public interface ProductRepo extends JpaRepository<Product,Long> {
    ...
    Page<Product> findProductByTitleContainingAndIsDeletedFalse(String title, Pageable pageable);// this method is used to find a product by title and isDeletedFalse
